  ...
  return (
    <div className="w-full max-w-[800px]">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="font-heading text-[32px] text-[#0A0A0A] font-bold">Edit Product</h1>
          <p className="font-body text-[15px] text-[#999999] mt-1">Update product details for #{id}</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="bg-white border border-[#E8E8E8] rounded-[14px] p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <InputField label="Sub-Category" name="subCategory" />
        ...
        <div className="bg-white border border-[#E8E8E8] rounded-[14px] p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <InputField label="Selling Price (₹)" name="price" type="number" required min="0" />
            <InputField label="MRP (₹)" name="mrp" type="number" min="0" />
            <InputField label="Stock Quantity" name="stock" type="number" required min="0" />
        ...
        <div className="bg-white border border-[#E8E8E8] rounded-[14px] p-8">
          ...
          <InputField label="Main Image URL" name="image" />
          {formData.image && (
