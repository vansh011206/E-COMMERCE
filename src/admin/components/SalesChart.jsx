...
const SalesChart = () => {
  ...
  // Calculate fake percentage for UI based on period (mock data approach)
  const percentChange = period === 7 ? 4.2 : period === 14 ? 8.5 : 12.5;
  ...
  return (
    ...
    >
      ...
      <div className="mb-6">
        ...
        <p className="font-body text-[13px] text-[#10B981]">
