  ...
  useEffect(() => {
    ...
    const placeOrder = async () => {
      if (items.length > 0 && orderData) {
        ...
        const selectedAddress = addresses?.find(a => a._id === orderData.addressId || a.id === orderData.addressId) || {};
        ...
        const orderPayload = {
          ...
          itemsPrice: orderData.finalTotal || 0,
          shippingPrice: orderData.paymentMethod === 'cod' ? 49 : 0,
          totalPrice: (orderData.finalTotal || 0) + (orderData.paymentMethod === 'cod' ? 49 : 0)
        };
